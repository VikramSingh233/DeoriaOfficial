...
const TicketCard = () => {
  ...
  useEffect(() => {
    ...
    script.setAttribute('data-payment_button_id', 'pl_QqboHc9oXaLBN9') // Replace with your Razorpay ID
    script.async = true
  ...
  return (
    ...
    >
      ...
      <form id="razorpay-form">
        <button
          type="submit"
          className="w-full mt-3 bg-pink-600 hover:bg-pink-700 text-white py-2 rounded-xl transition duration-300 shadow-md"
        >
          Buy Ticket
        </button>
      </form>
